...
export const Card: React.FC<CardProps> = ({ cardTitle, cardBody, link }) => {
  return (
    <a
      href="#"
      className="pop-in pb-12 relative group md:h-full block mx-auto rounded-lg p-6 bg-white ring-1 ring-slate-900/5 shadow-lg space-y-3 hover:bg-sky-500 hover:ring-sky-500"
    >
