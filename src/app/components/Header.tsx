...
export const Header: React.FC<HeaderProps> = ({ Title, Body }) => {
  return (
    <div
      ...
      className="relative top-20 h-[700px] xl:h-[600px] overflow-hidden rounded-lg bg-[url('https://media.istockphoto.com/id/1347197740/photo/business-people-having-casual-discussion-during-meeting.jpg?s=612x612&w=0&k=20&c=HSnFzyuwUDZFCehBv0W0jjRfwY1eKjGV1Lkek8lXY2Q=')] bg-cover bg-no-repeat text-white"
    >
      <div className="absolute bottom-0 left-0 right-0 top-0 overflow-hidden bg-black/60 bg-fixed">
        <div
          className={`${
            Body ? "mt-[150px]" : "mt-[300px] xl:mt-[200px]"
          } text-white grid grid-cols-8 gap-4`}
        >
          <div
            className={`col-start-2 col-span-6 xl:col-start-2 xl:col-span-3 ${
              !Body && ""
            }`}
          >
